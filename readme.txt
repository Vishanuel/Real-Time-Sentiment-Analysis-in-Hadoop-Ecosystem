...
2. Apache Flume is configured.
  1.1 A .conf file ("twitter.conf") containing the keyword search parameters as well the data sink parameters are clearly defined and         stored in "/path/to/flume/conf" folder.
...
7. Apache Flume is storing twitter data into hdfs in the "/user/Hadoop/twitter-data" folder.
